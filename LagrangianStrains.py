...
def main():
    ...
    # Load viscous dissipation rate matrix and compute y-averaged epsilon as a function of x
    # dissipation_matrix = np.load('D:/singlesource_2d_extended/viscous_dissipation_extendedSim.npy')
    # print(dissipation_matrix.shape)
    # epsilon_1d = np.mean(dissipation_matrix[100:1101, :], axis=0)
    # plt.plot(epsilon_1d)
    # plt.show()
    ...
    # t_list = np.array([0, 0.02, 0.04, 0.06, 0.08, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 5.75, 6, 6.5])
